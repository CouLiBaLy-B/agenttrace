  ...
  runs: [
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "classify intent", offsetSec: 0.2, durationMs: 480, payload: { prompt: "Classify the user intent...", result: "refund_request", tokens: 184 } },
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "draft response", offsetSec: 1.1, durationMs: 620, payload: { prompt: "Draft a friendly refund response...", result: "We're sorry your order didn't arrive...", tokens: 212 } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "classify intent", offsetSec: 0.2, durationMs: 460, payload: { result: "refund_request", tokens: 176 } },
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "decide retry", offsetSec: 4.8, durationMs: 380, payload: { result: "retry_once", tokens: 92 } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "classify intent", offsetSec: 0.2, durationMs: 440, payload: { result: "refund_request", tokens: 168 } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "classify intent", offsetSec: 0.2, durationMs: 420, payload: { result: "refund_request", tokens: 160 } },
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "draft apology", offsetSec: 1.2, durationMs: 510, payload: { result: "I couldn't find that order — could you double check the number?", tokens: 134 } },
  ...
  runs: [
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "synthesize summary", offsetSec: 3.0, durationMs: 2400, payload: { prompt: "Synthesize a cited summary...", tokens: 1240, result: "Axum, Actix-web, and Rocket remain the leading frameworks..." } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "synthesize summary", offsetSec: 2.7, durationMs: 2100, payload: { tokens: 980, result: "Use faithfulness, answer relevancy, and context precision metrics..." } },
  ...
  runs: [
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "analyze diff", offsetSec: 0.9, durationMs: 3200, payload: { prompt: "Review this diff for bugs and style...", tokens: 1840, result: "Retry logic is sound; consider exponential backoff. Line 42 missing error log." } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "analyze diff", offsetSec: 0.75, durationMs: 1900, payload: { tokens: 420, result: "Dependency bumps only. No behavioral changes." } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "analyze diff", offsetSec: 0.8, durationMs: 2600, payload: { tokens: 980, result: "Null check added correctly. Suggest early return for clarity." } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "analyze diff", offsetSec: 1.2, durationMs: 3000, payload: { tokens: 4200, result: "Large refactor. Potential regression: session invalidation removed at L210." } },
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "second pass (security)", offsetSec: 4.2, durationMs: 280, payload: { tokens: 540, result: "Confirm: session invalidation path removed — request changes." } },
    ...
    },
    {
      ...
      events: [
        ...
        { source: "Orchestrator", target: "LLM", type: "llm_call", label: "analyze diff", offsetSec: 0.6, durationMs: 1200, payload: { tokens: 320, result: "Docs only. Clear and accurate." } },
